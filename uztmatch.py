...
with st.container(border=True):
    ...
    col9, col10, col11, col12, col13, col14 = st.columns([1.5,1.5,1.5,1,1,1])
    with col9:
            ...
            if len(list_sum) >= 8:
                ...
                while 1:
                    ...
                    if dup_num == 1:
                        ...
                        if len(result[0]) == 12:
                            index_list = ['1st game','2nd game','3rd game','4th game']
                            df = pd.DataFrame(result, index=index_list)
                            ...
                            df=df[['1팀','2팀','3팀','4팀','5팀','6팀']]            
                            df.columns = ['1','2','1','2','1','2']
                            df.columns = [['1번 코트','1번 코트','2번 코트','2번 코트','3번 코트','3번 코트'],['1','2','1','2','1','2']]
                            # df4 = df3.rename(columns={'1팀': '1팀', '2팀': '2팀', '3팀': '1팀', '4팀': '2팀', '5팀': '1팀', '6팀': '2팀'})
